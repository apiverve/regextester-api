# Regex Tester API - Examples

This folder contains example code for using the Regex Tester API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/regextester',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/regextester");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/regextester](https://docs.apiverve.com/ref/regextester)
