...
const (
	baseURL        = "https://api.apiverve.com/v1/regextester"
	defaultTimeout = 30 * time.Second
)

// Client is the Regex Tester API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Regex Tester API client.
...
// Execute makes a request to the Regex Tester API with typed parameters.
//
