...
```gradle
dependencies {
    implementation 'com.github.apiverve:regextester-api:1.1.12'
}
```
...
```java
import com.apiverve.regextester.RegexTesterAPIClient;
import com.apiverve.regextester.APIResponse;
import com.apiverve.regextester.APIException;

// Initialize the client
RegexTesterAPIClient client = new RegexTesterAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/regextester](https://docs.apiverve.com/ref/regextester)
...
- **Documentation:** [https://docs.apiverve.com/ref/regextester](https://docs.apiverve.com/ref/regextester)
- **Issues:** [GitHub Issues](https://github.com/apiverve/regextester-api/issues)
