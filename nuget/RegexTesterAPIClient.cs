...
namespace APIVerve.API.RegexTester
{
    ...
    /// <summary>
    /// Client for the RegexTester API
    /// </summary>
    public class RegexTesterAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/regextester";
        ...
        {
            { "pattern", new ValidationRule { Type = "string", Required = true } },
            { "text", new ValidationRule { Type = "string", Required = true } },
            { "flags", new ValidationRule { Type = "string", Required = false } },
            { "test_type", new ValidationRule { Type = "string", Required = false } },
            { "replacement", new ValidationRule { Type = "string", Required = false } }
        };
        ...
        public RegexTesterAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public RegexTesterAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public RegexTesterAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, RegexTesterQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(RegexTesterQueryOptions options)
        {
        ...
        public ResponseObj Execute(RegexTesterQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(RegexTesterQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(RegexTesterQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(RegexTesterQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(RegexTesterQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(RegexTesterQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(RegexTesterQueryOptions options)
        {
