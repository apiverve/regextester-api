...
class regextesterWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/regextester');
        }
        ...
        this.validationRules = {"pattern":{"type":"string","required":true},"text":{"type":"string","required":true},"flags":{"type":"string","required":false},"test_type":{"type":"string","required":false,"default":"test"},"replacement":{"type":"string","required":false}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/regextester`);
        }
    }
...
module.exports = regextesterWrapper;
